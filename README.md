...
This repository contains the demo OpenMRS Open Web App.
...
This will create a file called `demo.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/home/gduchi/openmrs/server1/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "/home/gduchi/openmrs/server1/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "/home/gduchi/openmrs/server1/owa",
  "APP_ENTRY_POINT": "http://localhost:9994/openmrs/owa/demo/index.html"
}
```
